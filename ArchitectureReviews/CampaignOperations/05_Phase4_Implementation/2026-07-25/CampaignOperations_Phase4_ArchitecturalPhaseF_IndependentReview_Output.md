...
4. **High — pause gate had a database-level check/write race**
   ...
   - Correction: the authoritative gate now locks the campaign row before checking control state. See [migration 049](/Volumes/Developer%20SSD/ExpertAdvisor/Database/migrations/049_campaign_operations_controls_cancellation_reconciliation.sql:585).
...
- Migration 049 applied twice, including catalog, ACL, constraint, and replay checks
...
- [migration 049](/Volumes/Developer%20SSD/ExpertAdvisor/Database/migrations/049_campaign_operations_controls_cancellation_reconciliation.sql)
