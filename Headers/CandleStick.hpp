...
struct CandlePrice
{
    ...
    CandlePrice(db_forward_iterator<PricePoint>, db_forward_iterator<PricePoint>);
...
public:
    CandleStick(PriceTP candleTime, db_forward_iterator<PricePoint> start, db_forward_iterator<PricePoint> end)
