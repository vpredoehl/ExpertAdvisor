...
inline constexpr Donchian20Mode kDefaultDonchian20Mode = Donchian20Mode::Enabled;
...
inline Donchian20Mode ParseDonchian20Mode(const std::string& text)
{
    ...
    if (text == "zero_ablation")
        return Donchian20Mode::ZeroAblation;
    throw std::invalid_argument(
        "invalid --donchian20-mode value '" + text +
        "'; expected enabled or zero_ablation");
}

#endif /* Donchian20Mode_hpp */
