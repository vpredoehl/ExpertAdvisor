...
commands remain idempotent and auditable. A conflicting new administrative
command is rejected while another request is active, and partial failures
remain queryable for diagnosis.
