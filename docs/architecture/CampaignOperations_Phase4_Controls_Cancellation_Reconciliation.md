...
The scheduler-hardened integration installs this contract as migration 053,
after the unchanged global-control and scheduler migrations 049–052.
Scheduler generation fencing and exact-attempt authority are prerequisites;
they do not become Campaign Operations powers. Architectural Phase G
completion/audit behavior is not implemented and remains reserved for a
separate migration 054.
...
Migration 053 makes control and reconciliation history append-only, validates
