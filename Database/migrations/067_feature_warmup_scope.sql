-- Durable feature-generation semantics.  All rows predating this migration
-- used the cold logical-boundary query, so the forward-only default is the
-- legacy interpretation; new writes name full_history_warmup explicitly.
