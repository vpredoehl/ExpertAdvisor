    ...
    long long experimentId)
{
    const pqxx::result rows = transaction.exec(
        ...
        "resume_model_id,donchian20_mode FROM experiment WHERE experiment_id=$1;",
    ...
    const ExperimentInvocationConfiguration& invocation)
{
    ...
    return transaction.exec(
        ...
        "duplicate_nonce,status,phase,invocation_mode,donchian20_mode,updated_at) VALUES ("
        "$1,$2,$3,$4,$5,$6,$7,"
        ...
        "$12,0,'paused','train','recommendation_conversion',$14,now()) "
