...
test_dir="$(mktemp -d /tmp/ea_lstm_causal_directional_adverse_excursion.XXXXXX)"
...
"${CXX:-c++}" -std=c++20 -mmacosx-version-min=26.2 -Wall -Wextra -Werror \
    ...
    "${repo_root}/Tests/LSTMCausalDirectionalAdverseExcursionTests.cpp" \
    ...
    -o "${test_dir}/LSTMCausalDirectionalAdverseExcursionTests"
"${test_dir}/LSTMCausalDirectionalAdverseExcursionTests"
