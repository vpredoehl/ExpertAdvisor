...
test_dir="$(mktemp -d /tmp/ea_lstm_causal_return_autocorrelation.XXXXXX)"
...
"${CXX:-c++}" -std=c++20 -mmacosx-version-min=26.2 -Wall -Wextra -Werror \
    ...
    "${repo_root}/Tests/LSTMCausalReturnAutocorrelationTests.cpp" \
    ...
    -o "${test_dir}/LSTMCausalReturnAutocorrelationTests"
"${test_dir}/LSTMCausalReturnAutocorrelationTests"
