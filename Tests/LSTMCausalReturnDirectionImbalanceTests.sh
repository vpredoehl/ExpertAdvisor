...
test_dir="$(mktemp -d /tmp/ea_lstm_causal_return_direction_imbalance.XXXXXX)"
...
"${CXX:-c++}" -std=c++20 -mmacosx-version-min=26.2 -Wall -Wextra -Werror \
    ...
    "${repo_root}/Tests/LSTMCausalReturnDirectionImbalanceTests.cpp" \
    ...
    -o "${test_dir}/LSTMCausalReturnDirectionImbalanceTests"
"${test_dir}/LSTMCausalReturnDirectionImbalanceTests"
