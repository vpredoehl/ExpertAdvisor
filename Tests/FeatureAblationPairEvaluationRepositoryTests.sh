...
CREATE TABLE experiment (
    ...
    continuation_policy_target_epochs integer,
    continuation_policy_min_evals integer NOT NULL DEFAULT 2,
    ...
    continuation_policy_max_degradation double precision,
    continuation_policy_top_n integer,
    ...
    continuation_policy_progression_mode text,
    continuation_policy_target_sequence integer[],
    continuation_policy_target_increment integer,
    continuation_policy_max_target_epochs integer,
