...
test_dir="$(mktemp -d /tmp/ea_lstm_causal_multi_bar_range_pressure.XXXXXX)"
...
"${CXX:-c++}" -std=c++20 -mmacosx-version-min=26.2 -Wall -Wextra -Werror \
    ...
    "${repo_root}/Tests/LSTMCausalMultiBarRangePressureTests.cpp" \
    ...
    -o "${test_dir}/LSTMCausalMultiBarRangePressureTests"
"${test_dir}/LSTMCausalMultiBarRangePressureTests"
