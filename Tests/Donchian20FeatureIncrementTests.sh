...
test_dir="$(mktemp -d /tmp/ea_donchian20_feature_increment.XXXXXX)"
...
"${CXX:-c++}" -std=c++20 -mmacosx-version-min=26.2 -Wall -Wextra -Werror \
    ...
    "${repo_root}/Tests/Donchian20FeatureIncrementTests.cpp" \
    ...
    -o "${test_dir}/Donchian20FeatureIncrementTests"
"${test_dir}/Donchian20FeatureIncrementTests"
